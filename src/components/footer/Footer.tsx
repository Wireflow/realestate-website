  ...
  return (
    <Section background="pitch-black">
      <footer className="bg-black text-white">
        ...
        <div className="flex flex-wrap md:flex-nowrap md:justify-center xl:gap-40 gap-20">
          ...
          <div className="flex gap-20 flex-wrap">
            <div className="flex flex-col gap-4">
              ...
              <p className="max-w-[20rem]">
                ...
                estate market, I have honed my skills to navigate the
                complexities of the industry. Whether you&apos;re a first-time
                buyer, seasoned investor, or looking to sell, my expertise
                ensures a smooth and successful transaction.
              </p>
            </div>
            <div className="flex flex-col gap-4">
