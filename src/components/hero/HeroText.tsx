...
const HeroText = (props: Props) => {
  return (
    <div className="max-w-[50%]">
      ...
      <h1 className="text-[4.3rem] tracking-wider leading-[90px] font-semibold mt-4">
        Find Your Dream
        <br /> Home Today
      </h1>
      ...
      <div className="bg-dark-blue w-fit p-6 rounded-b-xl rounded-tr-xl flex gap-3 items-center mt-8">
        <div className="flex">
